...
if __name__ == "__main__":
    ...
    parser.add_argument("--other_mark", type=str, default="none",
                        help="mainly used for training 5 times")
    parser.add_argument("--attention_param", type=float, default=4,
                        help="attention parameter (reduction in CBAM and SE, e_lambda in simam, num_T in pdfam_gmm)")
    parser.add_argument("--attention_param2", type=float, default=2,
                        help="attention parameter2 (num_K in pdfam_gmm)")
    ...
    if args.attention_type.lower() != "none":
        ...
        args.ckpt += "-paramTwo" + str(args.attention_param2)

    if args.other_mark.lower() != "none":
        args.ckpt += "-mark_" + str(args.other_mark)
    ...
    # write to file
    args.log_file = open(os.path.join(args.ckpt, "log_file.txt"), mode="a")
